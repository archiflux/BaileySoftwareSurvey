    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F5F5F5] to-[#E0E0E0] py-12">
      <Container maxWidth="2xl">
        <Card className="text-center">
          ...
          <div className="bg-primary/5 border border-primary/30 rounded-lg p-6 mb-8 text-left max-w-2xl mx-auto">
            <h2 className="text-lg font-semibold uppercase tracking-wide mb-3" style={{ color: '#006064' }}>
              Submission Details
            </h2>
